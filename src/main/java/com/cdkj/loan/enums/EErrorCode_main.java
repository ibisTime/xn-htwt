...
public enum EErrorCode_main {
    ...
    user_TRADEPWDWRONG("000009", "旧交易密码不正确"),

    user_SAMETRADEPWD("000010", "新交易密码与原有交易密码重复"),
    ...
    user_MOBILE("000017", "手机号[%s]用户已存在"),

    user_USERIDUNEXIST("000018", "用户编号%s不存在"),

    user_TRADEPWDFIRST("000019", "请您先设置交易密码"),

    user_TRADEPWDISWRONG("000020", "交易密码错误"),
    ...
    accept_AMOUNTZERO("000173", "交易金额必须大于0"),

    accept_COUNTZERO("000174", "交易数量必须大于0"),
    ...
    account_GAMENOTEXIST("000043", "游戏账户异常"),
    ...
    ads_buy_ISEXIST("000057", "您已经有一个已上架的购买广告"),

    ads_sale_ISEXIST("0000178", "您已经有一个已上架的出售广告"),
    ...
    awa_MONTHSETTLE("000062", "不能结算非本月的奖励"),
    ...
    bla_INBLACKLIST("000066", "您的账号已在黑名单中无法进行交易"),
    ...
    simuorder_MINCOUNT("000106", "委托数量应当%s的整数倍"),

    simuorder_PRICELESSTHAN("000107", "委托价格不得高于行情价的%.2f%s"),

    simuorder_PRICEMORETHAN("000108", "委托价格不得低于行情价的%.2f%s"),
    ...
    tradeorder_CANNOTRELEASE("000129", "当前状态下不能解冻"),
    ...
    tradeorder_LeftCount("001136", "广告剩余量不足"),
    ...
    simuorder_PRICE_0("000175", "限价委托单委托价格需大于0"),

    bankCard_NOTEXIST("000176", "银行卡号不存在"),

    ethMAddress_UNSUPPORT("000177", "不支持的币种"),

    account_PLATLEFT("000179", "平台游戏账户可用余额不足"),

    account_GAMENOTAMOUNT("000180", "游戏账户可用余额不足"),

    account_GAMETRADENOEXIST("000181", "游戏转账交易编号已存在"),

    account_USERLOCK("000182", "您的账号已被管理员封禁"),

    account_GAME_AMOUNT_INCORRECT("000183", "游戏转账金额需大于零"),

    user_EMAILNOEXIST("000190", "邮箱不能为空"),

    user_EMAILFORMATWRONG("000191", "邮箱不正确"),

    simu_ORDER_PRICE_RULE("000200", "输入价格必须以%s为基数，按%s倍数上下浮动");
    ...
    public static void main(String[] args) {
        BigDecimal a = new BigDecimal("0.00002");
