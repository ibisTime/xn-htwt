...
public enum EBudgetOrderNode {
    WRITE_BUDGET_ORDER("002_01", "填写准入申请单"), AREA_APPROVE("002_24", "区域经理审核"), RISK_APPROVE(
            "002_02", "风控专员审核"), RISK_CHARGE_APPROVE("002_03", "风控主管审核"), AGAIN_WRITE(
            "002_04", "重新填写准入申请单"), INTERVIEW("002_05", "面签"), BIZ_CHARGE_APPROVE(
