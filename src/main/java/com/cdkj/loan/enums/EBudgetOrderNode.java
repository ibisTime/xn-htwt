...
public enum EBudgetOrderNode {
    WRITE_BUDGET_ORDER("002_01", "填写准入申请单"), AREA_APPROVE("002_24", "区域经理审核"), INTERNAL_APPROVE(
            ...
            "002_05", "面签"), BIZ_CHARGE_APPROVE("002_06", "业务总监审核"), INTERVIEW_INTERNAL_APPROVE(
            "002_26", "内勤主管审核"), ADVANCEFUND("002_07", "财务垫资"), AGAIN_INTERVIEW("002_08", "重新面签"),
    ...
    COMMITBANK("002_15", "驻行人员回录提交放款材料"), ENTRYLOAN("002_16", "录入放款信息"), CONFIRMLOAN(
            ...
            "002_21", "抵押完成"), ARCHIVE("002_22", "入档"), ARCHIVE_END("002_23","入档完成"),
