...
public class AbstractCredit {
    ...
    // 定义共同参数
    public static final String apiUrl = "https://t.limuzhengxin.cn";// 服务地址---需客户指定---需联系立木开启IP白名单

    public static final String apiKey = "9665866375902170";// API授权 key
                                                           // ---需客户指定

    public static final String apiSecret = "uMryJfeyNPHFtuB52h2BK1muD9JouBha";// API授权
                                                                              // secret---需客户指定
