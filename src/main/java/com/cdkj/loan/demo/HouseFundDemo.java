...
public class HouseFundDemo extends AbstractCredit {
    ...
    public static final String username = "130133198811170926";// 用户名---需客户指定

    public static final String password = "123456";// 密码---需客户指定

    public static final String area = "1301";// 地区码---需客户指定

    public static final String realName = "陈孟孟";// 真实姓名-非必填---需客户指定
