...
public class CreditAOImpl implements ICreditAO {
    ...
    public String addCredit(XN632110Req req) {
        ...
        String bizCode = null;
        //****待处理*****
//        cdbizBO.saveCdbiz(req.getLoanBankCode(),
...
//            req.getOperator(), sysUser.getTeamCode());
    ...
    public void distributeLeaflets(XN632119Req req) {
        ...
        Credit credit = null;
        //****待处理*****
        //creditBO.getCredit(req.getCreditCode());
...
//                credit.getCode(), ENode.renew_credit, cdbiz.getYwyUser());
    ...
    public void inputBankCreditResult(XN632111Req req) {
        ...
        ENode.matchCode(preCurNodeCode);
...
//            creditUserBO.inputBankCreditResult(creditUser, reqCreditUser.getCreditCardOccupation(),
//                    reqCreditUser.getBankResult(), reqCreditUser.getBankCreditReport(),
//                    reqCreditUser.getDataCreditReport(), reqCreditUser.getCreditNote());
...
//            req.getCreditCode(), ENode.input_credit);
    ...
    public void initCredit(Credit credit) {
        ...
        credit.setCreditUser(creditUserBO.getCreditUserByBizCode(
                credit.getCode(), ECreditUserLoanRole.APPLY_USER));
        // 从用户表查业务员姓名
        SYSUser user = null;
        //****待处理*****
        //sysUserBO.getUser(cdbiz.getYwyUser());
