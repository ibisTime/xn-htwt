...
public class Test {
    ...
    private static String[] DBwords = { "code", "budget_order_code",
            ...
            "home_photo", "basics_information", "xsz_pdf", "xsz_car_pdf",
            "frame_no", "nameplate", "forward_pdf", "queen_pdf", "left_pdf",
            "right_pdf", "lf45_pdf", "rf45_pdf", "lg45_pdf", "rr45_pdf",
            "engine_pdf", "szm_pdf", "gears_pdf", "functional_zone_pdf",
            "odometer_pdf", "front_row_pdf", "rock_row_pdf", "trunk_pdf",
            "louver_pdf", "bank_row_pdf", "check_approve_pdf",
            "check_approve_link", "third_valuation_pdf",
            "check_approve_software", "used_car_current_rate",
            "information_source", "valuation", "cur_node_code", "updater",
            "update_datetime", "remark" };

    private static String[] DBwordsName = { "编号", "预算单编号", "业务编号", "业务公司",
            "业务种类", "客户姓名", "申请时间", "贷款银行", "贷款金额", "贷款期数", "是否垫资", "业务员",
            "担保方式", "客户基本情况", "申请人征信情况", "申请人贷款车辆价格核准情况", "车行168车价",
            "申请人工作情况及流水反映", "银行流水", "银行流水情况", "支付宝流水", "支付宝流水情况", "微信流水",
            "微信流水情况", "房产情况及家访", "家访地址", "家访照片", "车辆基础信息", "行驶证主副页", "行驶证车辆照片页",
            "车架号", "车辆铭牌", "车辆照片正前", "车辆照片正后", "车辆照片正左", "车辆照片正右", "车辆照片左前45o",
            "车辆照片右前45o", "车辆照片左后45o", "车辆照片右后45o", "车辆照片发动机仓", "车辆中控台照片",
            "车辆档位照片", "车辆功能区里照片", "车辆里程表照片", "车辆前排内饰照片", "车辆中排内饰照片", "车辆后备箱照片",
            "车辆天窗照片", "车辆后排娱乐系统照片", "车辆核准截图", "核准链接", "第三方评估价截图", "核准软件",
