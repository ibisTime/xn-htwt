...
CREATE TABLE `tdq_investigate_report` (
  ...
  `customer_information` tinytext DEFAULT NULL COMMENT '客户基本情况',
  ...
  `168_price` bigint(20) DEFAULT NULL COMMENT '车行168车价',
  `apply_work_and_jour` tinytext DEFAULT NULL COMMENT '申请人工作情况及流水反映',
  `jour_pic` tinytext DEFAULT NULL COMMENT '银行流水',
  `jour_remark` tinytext DEFAULT NULL COMMENT '银行流水情况',
  `zfb_jour_pic` tinytext DEFAULT NULL COMMENT '支付宝流水',
  `zfb_jour_remark` tinytext DEFAULT NULL COMMENT '支付宝流水情况',
  `wx_jour_pic` tinytext DEFAULT NULL COMMENT '微信流水',
  `wx_jour_pdf` tinytext DEFAULT NULL COMMENT '微信流水情况',
  ...
  `basics_information` tinytext DEFAULT NULL COMMENT '车辆基础信息',
