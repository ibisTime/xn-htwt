...
INSERT INTO `tsys_dict` (`type`,`parent_key`,`dkey`,`dvalue`,`updater`,`update_datetime`,`remark`,`company_code`,`system_code`) VALUES ('1','education','0','高中及以下','U201806060410050085759',now(),'',NULL,NULL);
...
INSERT INTO `tsys_dict` (`type`,`parent_key`,`dkey`,`dvalue`,`updater`,`update_datetime`,`remark`,`company_code`,`system_code`) VALUES ('1','bus_status','2','已作废','U201806061344020605969',now(),'','CD-HTWT000020','CD-HTWT000020');
