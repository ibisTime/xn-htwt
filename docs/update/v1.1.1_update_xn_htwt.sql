...
INSERT INTO `tsys_dict` (`type`,`parent_key`,`dkey`,`dvalue`,`updater`,`update_datetime`,`remark`,`company_code`,`system_code`) VALUES ('1','bus_status','2','已作废','admin',now(),NULL,'CD-HTWT000020','CD-HTWT000020');
