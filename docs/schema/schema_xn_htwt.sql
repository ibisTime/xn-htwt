...
(
  ...
  `paper_photo`                  LONGTEXT COMMENT '纸质申请照片',
  `is_advance_settled`           varchar(255)  DEFAULT NULL COMMENT '是否提前结清(0=正常结清 1=提前结清)',
  `settle_attach`                LONGTEXT  DEFAULT NULL COMMENT '结清证明',
...
(
  ...
  `remark`            varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`code`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8 COMMENT ='返点账号列表';
...
(
  ...
  `repay_first_month_datetime` varchar(255) DEFAULT NULL,
  `repay_first_month_amount`   varchar(255) DEFAULT NULL,
  `repay_month_amount`         varchar(255) DEFAULT NULL,
  `bank_fk_date`               varchar(255) DEFAULT NULL,
  PRIMARY KEY (`code`)
