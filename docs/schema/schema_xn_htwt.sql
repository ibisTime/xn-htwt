...
--
-- Host: 47.99.163.139    Database: dev_xn_htwt
-- ------------------------------------------------------
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='平台银行信息表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='银行支行信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='经销商信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='经销商协议表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='收款账号表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='gps库存管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='gps申领管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='导入逾期名单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='逾期名单关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='返点表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='财务垫资';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='银行放款';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='准入单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  `pledge_user_id_card_copy`    tinytext COMMENT '代理人身份证复印件',
  ...
  DEFAULT CHARSET = utf8 COMMENT ='车辆抵押';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='征信流水';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='征信人辅助资料';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='调查报告';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户行为';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='车型配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='车辆资讯';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='车辆配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='人事档案';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='档案存放位置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='领导请示申请';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='办公用品/固定资产';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='办公物品列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='办公用户列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='公车';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='公车借用';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='出差申请';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='车辆违章处理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='考核项目';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='类别管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='品名管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='公司制度';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='转正申请';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  AUTO_INCREMENT = 156
  DEFAULT CHARSET = utf8 COMMENT ='休息日记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='应聘岗位';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='入职申请';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='费用预支申请';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='请假申请';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  AUTO_INCREMENT = 287
  DEFAULT CHARSET = utf8 COMMENT ='公告阅读记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='加班申请';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  AUTO_INCREMENT = 9
  DEFAULT CHARSET = utf8 COMMENT ='试用期评估';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='用人申请';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  AUTO_INCREMENT = 5
  DEFAULT CHARSET = utf8 COMMENT ='公告或制度人员范围';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='社会关系';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='入库管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='出库管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='补签申请';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='补签申请明细';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='调岗申请';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='出差/公出申请';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='时间申请明细';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='福利发放申请';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='福利关联人员';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='工作经历';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='附件 ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='待办事项表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='业务团队';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  AUTO_INCREMENT = 8
  DEFAULT CHARSET = utf8 COMMENT ='表格导出';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-05-04 21:41:55
