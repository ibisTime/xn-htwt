...
CREATE TABLE `tdq_budget_order` (
  ...
  `house_invoice` varchar(255) DEFAULT NULL COMMENT '购房发票',
  ...
  `apply_user_hkb` varchar(255) DEFAULT NULL COMMENT '户口本(主贷本人页)',
  `bank_bill_pdf` varchar(255) DEFAULT NULL COMMENT '银行流水',
  `single_prove_pdf` varchar(255) DEFAULT NULL COMMENT '单身证明',
  `income_prove_pdf` varchar(255) DEFAULT NULL COMMENT '收入证明',
  `live_prove_pdf` varchar(255) DEFAULT NULL COMMENT '居住证明',
  `build_prove_pdf` varchar(255) DEFAULT NULL COMMENT '自建房证明',
  `hkb_first_page` varchar(255) DEFAULT NULL COMMENT '户口本（首页）',
  `hkb_main_page` varchar(255) DEFAULT NULL COMMENT '户口本（户主页）',
  `gh_hkb` varchar(255) DEFAULT NULL COMMENT '共还人户口本',
  `guarantor1_id_no` varchar(255) DEFAULT NULL COMMENT '担保人1身份证',
  `guarantor1_hkb` varchar(255) DEFAULT NULL COMMENT '担保人1户口本',
  `guarantor2_id_no` varchar(255) DEFAULT NULL COMMENT '担保人2身份证',
  `guarantor2_hkb` varchar(255) DEFAULT NULL COMMENT '担保人2户口本',
  ...
  `house_customer_pic` varchar(255) DEFAULT NULL COMMENT '主贷与住宅合影',
  `house_sale_customer_pic` varchar(255) DEFAULT NULL COMMENT '签约员与客户在房子合影照片',
  
  `company_name_pic` varchar(255) DEFAULT NULL COMMENT '企业名称照片',
  `company_place_pic` varchar(255) DEFAULT NULL COMMENT '办公场地照片',
  `company_workshop_pic` varchar(255) DEFAULT NULL COMMENT '生产车间照片',
  `company_sale_customer_pic` varchar(255) DEFAULT NULL COMMENT '签约员与客户在公司合影照片',
  ...
  `second_300_pdf` varchar(255) DEFAULT NULL COMMENT '车300评估页',
  ...
  `other_file_pdf` varchar(255) DEFAULT NULL COMMENT '其他材料附件',
  `other_apply_note` varchar(255) DEFAULT NULL COMMENT '申请说明事项',
  `apply_datetime` datetime DEFAULT NULL COMMENT '申请时间',
  ...
  `bank_receipt_pdf` varchar(255) DEFAULT NULL COMMENT '收款凭证',
  `bank_receipt_note` text DEFAULT NULL COMMENT '收款说明',
  ...
  `insurance_company_code` varchar(255) DEFAULT NULL COMMENT '保险公司编号',
  ...
  `zf_reason` varchar(255) DEFAULT NULL COMMENT '作废原因',
  `zf_sk_amount` bigint(20) DEFAULT NULL COMMENT '收款金额',
  `zf_sk_bank` varchar(255) DEFAULT NULL COMMENT '收款银行',
  `zf_sk_bankcard_number` varchar(255) DEFAULT NULL COMMENT '收款账号',
  `zf_sk_receipt_datetime` datetime DEFAULT NULL COMMENT '收款时间',
  `zf_finance_remark` varchar(255) DEFAULT NULL COMMENT '财务备注',
  `cur_node_code` varchar(32) DEFAULT NULL COMMENT '节点编号',
  PRIMARY KEY (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
